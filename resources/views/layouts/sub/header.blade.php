<header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <i class="bi bi-list toggle-sidebar-btn"
            @click="sidebar_toggle=!sidebar_toggle; docCookies.setItem('sidebar_toggle', sidebar_toggle, (7*24*60*60));"></i>
    </div>
    <!-- End Logo -->
    ...
    <nav class="header-nav ms-auto">
        <ul class="d-flex align-items-center">
            ...
            @livewire('layout.profile-dropdown-liveiwre', key('profile-dropdown-liveiwre'))
        </ul>
    </nav>
</header>